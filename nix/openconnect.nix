{ lib, stdenv, fetchFromGitLab, pkg-config, autoreconfHook, gnutls, p11-kit
, openssl, useOpenSSL ? false, gmp, libxml2, stoken, zlib, pcsclite
, vpnc-scripts, xdg-utils, useDefaultExternalBrowser ?
...
stdenv.mkDerivation {
  ...
  meta = {
    ...
    maintainers = with lib.maintainers; [ tricktron pentane ];
